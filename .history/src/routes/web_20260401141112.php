...
Route::get('/', [ItemController::class, 'index'])->name('index.index');
Route::get('/mylist', [ItemController::class, 'tab_index'])->name('mylist.index');
...
Route::get('/purchase/{item_id}', [PurchaseController::class, 'ajax'])->name('purchase.ajax');
...
Route::get('/mypage', [MypageController::class, 'index'])->name('mypage_sell.index');
Route::get('/mypage/buy', [MypageController::class, 'tab_index'])->name('mypage_buy.index');
