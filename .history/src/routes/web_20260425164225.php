...
Route::middleware('auth')->group(function () {
    ...
    //Route::post('/purchase/store/{item_id}', [PurchaseController::class, 'success'])->name('purchase.success');
    //Route::post('/purchase/store/{item_id}', [PurchaseController::class, 'cancel'])->name('purchase.cancel');
