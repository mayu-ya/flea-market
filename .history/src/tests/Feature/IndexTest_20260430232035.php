...
class IndexTest extends TestCase
{
    ...
    {
        $merchandises = Merchandise::factory()->count(10)->create(['email_verified_at' => now(),]);
    ...
    {
        $merchandise = Merchandise::factory()->hasPurchase()->create(['email_verified_at' => now(),]);
    ...
    public function test_mylist_search()
    {
        $user = User::factory()->hasProfile()->create(['email_verified_at' => now(),]);
        $merchandise = Merchandise::factory()->create([
            'merchandise_name' => '商品'
        ...
        $response = $this->get('/?tab=mylist&keyword=品');
