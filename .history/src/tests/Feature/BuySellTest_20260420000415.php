...
class BuySellTest extends TestCase
{
    ...
    {
        $user = User::factory()->hasProfile()->create();
        $categoryId = Category::factory()->create(['id' => 20]);
    ...
    dd(session('errors')->getMessages());
        ...
        // 全ての merchandise を表示
//dump(\App\Models\Merchandise::all()->toArray());
// 全ての detail を表示
//dump(\App\Models\Detail::all()->toArray());

//$this->assertDatabaseHas('details', ['category_id' => $categoryId]);
