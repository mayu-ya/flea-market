...
class ItemTest extends TestCase
{
    ...
    public function test_item()
    {
        ...
        //$response->assertSee($merchandise->category->content);
        //$response->assertSee($merchandise->comment->profile_id);
        //$response->assertSee($merchandise->comment->contact);
        //$response->assertDatabaseCount('comments', 1);
        $response->assertDatabaseCount('likes', 1);
    }
