...
class ItemController extends Controller
{
    ...
    public function tab_index()
    {
        ...
        return view('mylist', compact('merchandises', 'tab'));
   }

    public function mix_index(Request $request, ItemController $tab)
    {
        //クエリパラメータがあるとき、マイリストを表示
        //ないとき、一覧を表示
        if ($tab == 'mylist') {
            ...
            //return view('mylist', compact('merchandises', 'tab'));
            return $this->tab_index()->with('tab');
        } else {
            return $this->index();
        }
    }
    ...
    {
        $merchandises = Merchandise::select('merchandise_name', 'id', 'image')->KeywordSearch($request->keyword)->get();
