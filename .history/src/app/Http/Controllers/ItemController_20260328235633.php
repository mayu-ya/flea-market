...
class ItemController extends Controller
{
    public function index()
    {
        ...
        $merchandises = Merchandise::with('purchase')
    ...
    {
        $profileId =  Auth::check() ? Auth::user()->profile->id: null;
        $likeIds = Like::where('profile_id', '=', $profileId)->only('merchandise_id');
        $merchandises = Merchandise::where('merchandise_id', '=', $likeIds)->get();
