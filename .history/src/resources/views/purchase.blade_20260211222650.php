...
<form class="form">
    ...
    <div class="content">
        <div class="address">
            ...
            <div class="address-input">
                <label for="">〒<input type="text" name="post_code"></label>
    ...
    <div class="pay-p">
        <div class="pay-item-i">支払い方法</div>
        <select name="" id="" class="pay-select-s">
            <option value="">選択してください</option>
            <option value="">コンビニ払い</option>
            <option value="">カード支払い</option>
        </select>
    ...
    <div class="button-b">
        <button class="button-submit-s" type="submit">購入する</button>
    </div>
