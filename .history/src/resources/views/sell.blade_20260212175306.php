...
<form class="form">
    ...
    <div class="content">
        ...
        <label><input type="checkbox" class="content-input" id="fashion"><span>ファッション</span></label>
        <label for="appliances"><input type="checkbox" class="content-input" id="appliances">家電</label>
