        ...
        <form class="form-comment" action="/posts/comment" method="post">
            ...
            <div class="profile">
                ...
                <div class="profile-avatar">
                    ...
                    <input type="text" class="profile-input" value="{{ session('reply')->profile->name ?? '' }}" readonly>
                </div>
                <textare name="contact" class="profile-textarea" readonly>{{ session('reply')->contact ?? '' }}</textare>
                @endif
            </div>
            <div class="text">
                <span class="comment-span">商品へのコメント</span>
                <textarea class="comment-textarea" name="contact"></textarea>
                <input type="hidden" name="merchandise_id" value="{{ $merchandise }}">
