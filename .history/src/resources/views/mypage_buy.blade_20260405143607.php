...
<div class="content">
    <div class="category">
        <a href="{{ route('mypage.index', ['page' => 'sell']) }}" class="category-a"><h3 class="category-item">出品した商品</h3></a>
        <a href="{{ route('mypage.index') }}" class="category-a"><h3 class="category-mylist">購入した商品</h3></a>
    </div>
    <div class="form-list"> 
        <div class="list">
