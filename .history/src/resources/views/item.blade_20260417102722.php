...
<div class="content">
    <div class="form-img">
        <img src="{{ asset($merchandise->image) }}" alt="" class="img-picture">
    </div>
    ...
    <div class="content-infoemation">
        <div class="content-item">
            ...
            <div class="money">
                <label>￥</label>
                <input type="text" class="information-price" value="{{ $merchandise->price }}" readonly>
            </div>
            <div class="img">
                <div>
            ...
            <div class="information">
                <div class="information-title">
                    ...
                    @foreach($merchandise->vategories as $category)
